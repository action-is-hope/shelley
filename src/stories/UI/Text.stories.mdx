...
An an Icon or some other element quickly via the `startAdornment` and `endAdornment` props. This is a good way to add some visual interest to your text without having to create a new component.
...
>
  ...
  <P vol={2} startAdornment={<Success />}>
    vol 2. Text
  </P>
  <P startAdornment={<Success />}>vol 3. Text</P>
  <P vol={4} startAdornment={<Success />}>
    vol 4. Text
  </P>
  <P vol={5} startAdornment={<Success />}>
    vol 5. Text
  </P>
</Story>
