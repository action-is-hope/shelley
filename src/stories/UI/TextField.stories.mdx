...
import { P, Blockquote, InputText, InputBase } from "../../indexLib";
...
export const BasicTextField = (args) => <InputText {...args} />;
...
<Story
  ...
  parameters={{
    docs: {
      source: {
        code: dedent`<InputText label="Name" />`,
      },
    },
  }}
>
...
<Source language="tsx" id="inputs-textfield--i-input-adornments" />
