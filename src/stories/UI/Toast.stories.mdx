        ...
        return (
          <>
            <Button
              onClick={() =>
                state.add(
                  { title: "Bread can be toasted.", actionLabel: "Got it" },
                  { priority: 1 }
                )
              }
              style={{ margin: "16px" }}
            ...
            <Button
              onClick={() =>
                state.add(
                  { title: "Toasting...! (1)", actionLabel: "Thanks" },
                  { priority: 1 }
                )
              }
              style={{ margin: "16px" }}
            ...
            <Button
              onClick={() =>
                state.add(
                  { title: "Toast is done! (2)", actionLabel: "Check" },
                  { priority: 2 }
                )
              }
              style={{ margin: "16px" }}
            ...
            <Button
              onClick={() =>
                state.add(
                  { title: "Toast is burnt! (3)", actionLabel: "Fix" },
                  { priority: 3 }
                )
              }
              style={{ margin: "16px" }}
