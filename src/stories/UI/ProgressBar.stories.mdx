...
>
  <ProgressBar aria-label="Loading…" value={90} minValue={0} totalSteps={1} maxValue={100}/>
</Story>
...
>
  <ProgressBar aria-label="Loading…" label="Loading…"value={90} minValue={0} totalSteps={1} maxValue={100}/>
</Story>

<Source language="tsx" id="status-progressbar--a-label" />
