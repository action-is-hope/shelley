...
<Source language="tsx" id="data-tableview--f-selection" />
...
TBC`,
  ...
  >
    <ControlledSelectionExample selectionMode={"single"} />
  </Story>
</Preview>
...
TBC`,
  ...
  >
    <ControlledSelectionExample disallowEmptySelection />
  </Story>
</Preview>
...
TBC`,
  ...
  >
    <ControlledSelectionExample selectionMode="multiple" disabledKeys={[3]} />
  </Story>
</Preview>
...
<Preview>
  <Story
    name="k) Highlight selection selection"
    parameters={{
      docs: {
        source: {
          code: dedent`
TBC`,
  ...
  >
    <ControlledSelectionExample selectionMode="highlight" />
  </Story>
</Preview>
