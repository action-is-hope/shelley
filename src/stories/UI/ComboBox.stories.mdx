...
<Source language="tsx" id="inputs-combobox--d-custom-value" />
...
<Source language="tsx" id="inputs-combobox--e-labeling" />
...
<Source language="tsx" id="inputs-combobox--f-selection" />
...
<Source language="tsx" id="inputs-combobox--g-events" />
...
<Source language="tsx" id="inputs-combobox--h-fully-controlled" />
...
<Source language="tsx" id="inputs-combobox--i-multi-select" />
...
<Source language="tsx" id="inputs-combobox--j-disabled" />
...
<Source language="tsx" id="inputs-combobox--k-read-only" />
...
<Source language="tsx" id="inputs-combobox--l-help" />

## ComboBox Props

<Story
  name="m) Asynchronous loading"
  parameters={{
    docs: {
      source: {
        code: dedent`
...
<Source language="tsx" id="inputs-combobox--m-asynchronous-loading" />

<ArgsTable of={ComboBoxType} />
