...
It's flexible, you don't have to use the props that we provide, you could just use classnames and inherit the style api from whatever component you are using and style it's internal parts easily.
